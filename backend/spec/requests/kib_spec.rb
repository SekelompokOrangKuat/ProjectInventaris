  ...
  path '/v1/kib/kibe/create' do
    post 'Create KIB E' do
      ...
      parameter name: :body, in: :body, schema: {
        ...
        properties: {
          kode_lokasi: {type: :string, example: "01.02.03.04.05"},
          nama_barang: {type: :string, example: "Buku"},
          nomor_register: {type: :string, example: "0001"},
          judul_buku: {type: :string, example: "Hujan"},
          spesifikasi_buku: {type: :string, example: "Novel"},
          asal_kesenian: {type: :string, example: "Sastra"},
          pencipta_kesenian: {type: :string, example: "Tereliye"},
          bahan_kesenian: {type: :string, example: "Buku"},
          jenis: {type: :string, example: "Fiksi"},
          jumlah: {type: :string, example: "1"},
          ukuran: {type: :string, example: "12x18 cm"},
          tahun_pembelian: {type: :string, example: "2011"},
          asal_usul: {type: :string, example: "APBD"},
          harga: {type: :string, example: "Rp. 100000"},
          keterangan: {type: :string, example: "Layak Pakai"},
        },
        required: []
      }
    ...
    post 'Edit KIB E' do
      ...
      parameter name: :body, in: :body, schema: {
        ...
        properties: {
          ...
          nama_barang: {type: :string, example: "Buku"},
          nomor_register: {type: :string, example: "0002"},
          judul_buku: {type: :string, example: "Hujan Di Mimpi"},
          spesifikasi_buku: {type: :string, example: "Novel"},
          asal_kesenian: {type: :string, example: "Sastra"},
          pencipta_kesenian: {type: :string, example: "Gemintang"},
          bahan_kesenian: {type: :string, example: "Buku"},
          jenis: {type: :string, example: "Fiksi"},
          ...
          asal_usul: {type: :string, example: "APBD"},
          harga: {type: :string, example: "Rp. 90000"},
          keterangan: {type: :string, example: "Layak Pakai"},
        },
        required: []
      }
